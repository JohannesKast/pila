...
- [x] **Rate-Limiting für alle POST-Routen**  
...
- [x] **Security-Header (CSP, HSTS, X-Frame-Options, X-Content-Type-Options)**  
...
- [x] **CSRF-Schutz auf State-Changing POSTs prüfen**  
...
- [x] **`setup_post`: Liga + Settings + User in eine DB-Transaktion packen**  
...
- [x] **`unwrap()` auf `Template::render()` durch `.map_err()` ersetzen**  
