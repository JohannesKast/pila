...
const JERSEYS_JSON: &str = r##"{
  "presets": {
    ...
    "classic":            { "body": "#f3f3ed", "accent": "#222222", "pattern": "solid",    "name": "Classic",             "group": "Pila",     "variant": "home" },

    "argentinien":        { "body": "#75aadb", "accent": "#f3f3ed", "pattern": "vstripes", "name": "Argentina",         "group": "CONMEBOL", "variant": "home" },
    "argentinien-away":   { "body": "#1a1a2e", "accent": "#75aadb", "pattern": "hoops",    "name": "Argentinien Away",    "group": "CONMEBOL", "variant": "away" },
    "brasilien":          { "body": "#ffdf00", "accent": "#009c3b", "pattern": "solid",    "name": "Brazil",           "group": "CONMEBOL", "variant": "home" },
    ...
    "kolumbien":          { "body": "#fcd116", "accent": "#003893", "pattern": "solid",    "name": "Colombia",           "group": "CONMEBOL", "variant": "home" },
    ...
    "mexiko":             { "body": "#1f8a3b", "accent": "#f3f3ed", "pattern": "solid",    "name": "Mexico",              "group": "CONCACAF", "variant": "home" },
    "mexiko-away":        { "body": "#f3f3ed", "accent": "#1f8a3b", "pattern": "vstripes", "name": "Mexiko Away",         "group": "CONCACAF", "variant": "away" },
    "kanada":             { "body": "#dc2626", "accent": "#f3f3ed", "pattern": "solid",    "name": "Canada",              "group": "CONCACAF", "variant": "home" },
    ...
    "jamaika":            { "body": "#fcd116", "accent": "#1f8a3b", "pattern": "solid",    "name": "Jamaica",             "group": "CONCACAF", "variant": "home" },
    "jamaika-away":       { "body": "#1f8a3b", "accent": "#fcd116", "pattern": "vstripes", "name": "Jamaika Away",        "group": "CONCACAF", "variant": "away" },

    "deutschland":        { "body": "#f3f3ed", "accent": "#0a0f0c", "pattern": "hoops",    "name": "Germany",         "group": "UEFA",     "variant": "home" },
    "deutschland-away":   { "body": "#1a1a2e", "accent": "#dc2626", "pattern": "solid",    "name": "Deutschland Away",    "group": "UEFA",     "variant": "away" },
    "frankreich":         { "body": "#0055a4", "accent": "#ef4135", "pattern": "solid",    "name": "France",          "group": "UEFA",     "variant": "home" },
    ...
    "spanien":            { "body": "#c8102e", "accent": "#ffd100", "pattern": "solid",    "name": "Spain",             "group": "UEFA",     "variant": "home" },
    ...
    "niederlande":        { "body": "#ff6f00", "accent": "#0a0f0c", "pattern": "solid",    "name": "Netherlands",         "group": "UEFA",     "variant": "home" },
    "niederlande-away":   { "body": "#1a1a2e", "accent": "#ff6f00", "pattern": "vstripes", "name": "Niederlande Away",    "group": "UEFA",     "variant": "away" },
    "belgien":            { "body": "#a40026", "accent": "#fae042", "pattern": "solid",    "name": "Belgium",             "group": "UEFA",     "variant": "home" },
    "belgien-away":       { "body": "#fae042", "accent": "#a40026", "pattern": "solid",    "name": "Belgien Away",        "group": "UEFA",     "variant": "away" },
    "italien":            { "body": "#1d4ed8", "accent": "#ffd700", "pattern": "solid",    "name": "Italy",             "group": "UEFA",     "variant": "home" },
    "italien-away":       { "body": "#f3f3ed", "accent": "#1d4ed8", "pattern": "vstripes", "name": "Italien Away",        "group": "UEFA",     "variant": "away" },
    "kroatien":           { "body": "#f3f3ed", "accent": "#dc2626", "pattern": "check",    "name": "Croatia",            "group": "UEFA",     "variant": "home" },
    "kroatien-away":      { "body": "#1a1a2e", "accent": "#dc2626", "pattern": "check",    "name": "Kroatien Away",       "group": "UEFA",     "variant": "away" },
    "schweiz":            { "body": "#dc2626", "accent": "#f3f3ed", "pattern": "solid",    "name": "Switzerland",             "group": "UEFA",     "variant": "home" },
    "schweiz-away":       { "body": "#f3f3ed", "accent": "#dc2626", "pattern": "halves",   "name": "Schweiz Away",        "group": "UEFA",     "variant": "away" },
    "daenemark":          { "body": "#c8102e", "accent": "#f3f3ed", "pattern": "solid",    "name": "Denmark",            "group": "UEFA",     "variant": "home" },
    "daenemark-away":     { "body": "#f3f3ed", "accent": "#c8102e", "pattern": "vstripes", "name": "Denmark Away",       "group": "UEFA",     "variant": "away" },
    "polen":              { "body": "#f3f3ed", "accent": "#dc143c", "pattern": "solid",    "name": "Poland",               "group": "UEFA",     "variant": "home" },
    "polen-away":         { "body": "#dc143c", "accent": "#f3f3ed", "pattern": "solid",    "name": "Polen Away",          "group": "UEFA",     "variant": "away" },
    "oesterreich":        { "body": "#dc2626", "accent": "#f3f3ed", "pattern": "vbands",   "name": "Austria",          "group": "UEFA",     "variant": "home" },
    "oesterreich-away":   { "body": "#f3f3ed", "accent": "#dc2626", "pattern": "vbands",   "name": "Austria Away",     "group": "UEFA",     "variant": "away" },
    "ungarn":             { "body": "#cd2a3e", "accent": "#436f4d", "pattern": "solid",    "name": "Hungary",              "group": "UEFA",     "variant": "home" },
    "ungarn-away":        { "body": "#f3f3ed", "accent": "#cd2a3e", "pattern": "vstripes", "name": "Ungarn Away",         "group": "UEFA",     "variant": "away" },
    "tuerkei":            { "body": "#e30a17", "accent": "#f3f3ed", "pattern": "solid",    "name": "Turkey",              "group": "UEFA",     "variant": "home" },
    "tuerkei-away":       { "body": "#f3f3ed", "accent": "#e30a17", "pattern": "halves",   "name": "Turkey Away",         "group": "UEFA",     "variant": "away" },
    "serbien":            { "body": "#c6363c", "accent": "#0c4076", "pattern": "solid",    "name": "Serbia",             "group": "UEFA",     "variant": "home" },
    ...
    "schottland":         { "body": "#0d3b66", "accent": "#f3f3ed", "pattern": "solid",    "name": "Scotland",          "group": "UEFA",     "variant": "home" },
    "schottland-away":    { "body": "#f3f3ed", "accent": "#0d3b66", "pattern": "vstripes", "name": "Schottland Away",     "group": "UEFA",     "variant": "away" },
    "norwegen":           { "body": "#ba0c2f", "accent": "#f3f3ed", "pattern": "solid",    "name": "Norway",            "group": "UEFA",     "variant": "home" },
    "norwegen-away":      { "body": "#f3f3ed", "accent": "#ba0c2f", "pattern": "halves",   "name": "Norwegen Away",       "group": "UEFA",     "variant": "away" },
    "schweden":           { "body": "#fecc02", "accent": "#005293", "pattern": "solid",    "name": "Sweden",            "group": "UEFA",     "variant": "home" },
    ...
    "suedkorea":          { "body": "#dc2626", "accent": "#0a0f0c", "pattern": "solid",    "name": "South Korea",            "group": "AFC",      "variant": "home" },
    "suedkorea-away":     { "body": "#1a1a2e", "accent": "#dc2626", "pattern": "vstripes", "name": "South Korea Away",       "group": "AFC",      "variant": "away" },
    "australien":         { "body": "#fde047", "accent": "#1f8a3b", "pattern": "solid",    "name": "Australia",          "group": "AFC",      "variant": "home" },
    ...
    "saudi":              { "body": "#f3f3ed", "accent": "#006c35", "pattern": "solid",    "name": "Saudi Arabia",       "group": "AFC",      "variant": "home" },
    "saudi-away":         { "body": "#006c35", "accent": "#f3f3ed", "pattern": "solid",    "name": "Saudi-Arabien Away",  "group": "AFC",      "variant": "away" },
    "katar":              { "body": "#7a1432", "accent": "#f3f3ed", "pattern": "solid",    "name": "Qatar",               "group": "AFC",      "variant": "home" },
    "katar-away":         { "body": "#f3f3ed", "accent": "#7a1432", "pattern": "halves",   "name": "Katar Away",          "group": "AFC",      "variant": "away" },
    "irak":               { "body": "#1f8a3b", "accent": "#f3f3ed", "pattern": "solid",    "name": "Iraq",                "group": "AFC",      "variant": "home" },
    "irak-away":          { "body": "#f3f3ed", "accent": "#1f8a3b", "pattern": "vstripes", "name": "Irak Away",           "group": "AFC",      "variant": "away" },
    "usbekistan":         { "body": "#f3f3ed", "accent": "#0099b5", "pattern": "solid",    "name": "Uzbekistan",          "group": "AFC",      "variant": "home" },
    "usbekistan-away":    { "body": "#0099b5", "accent": "#f3f3ed", "pattern": "solid",    "name": "Usbekistan Away",     "group": "AFC",      "variant": "away" },

    "marokko":            { "body": "#c1272d", "accent": "#1f8a3b", "pattern": "solid",    "name": "Morocco",             "group": "CAF",      "variant": "home" },
    "marokko-away":       { "body": "#1f8a3b", "accent": "#c1272d", "pattern": "solid",    "name": "Marokko Away",        "group": "CAF",      "variant": "away" },
    "tunesien":           { "body": "#e70013", "accent": "#f3f3ed", "pattern": "solid",    "name": "Tunisia",            "group": "CAF",      "variant": "home" },
    "tunesien-away":      { "body": "#f3f3ed", "accent": "#e70013", "pattern": "vstripes", "name": "Tunesien Away",       "group": "CAF",      "variant": "away" },
    "algerien":           { "body": "#f3f3ed", "accent": "#006233", "pattern": "halves",   "name": "Algeria",            "group": "CAF",      "variant": "home" },
    "algerien-away":      { "body": "#006233", "accent": "#f3f3ed", "pattern": "solid",    "name": "Algerien Away",       "group": "CAF",      "variant": "away" },
    "aegypten":           { "body": "#cf0921", "accent": "#0a0f0c", "pattern": "solid",    "name": "Egypt",             "group": "CAF",      "variant": "home" },
    "aegypten-away":      { "body": "#0a0f0c", "accent": "#cf0921", "pattern": "vstripes", "name": "Egypt Away",        "group": "CAF",      "variant": "away" },
    ...
    "kamerun":            { "body": "#1f8a3b", "accent": "#fcd116", "pattern": "solid",    "name": "Cameroon",             "group": "CAF",      "variant": "home" },
    ...
    "elfenbein":          { "body": "#ff8200", "accent": "#1f8a3b", "pattern": "solid",    "name": "Ivory Coast",      "group": "CAF",      "variant": "home" },
    "elfenbein-away":     { "body": "#1f8a3b", "accent": "#ff8200", "pattern": "solid",    "name": "Ivory Coast Away", "group": "CAF",      "variant": "away" },
    "suedafrika":         { "body": "#fcd116", "accent": "#1f8a3b", "pattern": "solid",    "name": "South Africa",           "group": "CAF",      "variant": "home" },
    "suedafrika-away":    { "body": "#1f8a3b", "accent": "#fcd116", "pattern": "vstripes", "name": "South Africa Away",      "group": "CAF",      "variant": "away" },
